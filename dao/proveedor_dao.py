...
class proveedorDAO:
    ...
    def insertar(self, proveedor):
        ...
        cursor = conexion.cursor()
        cursor.execute(
            "INSERT INTO proveedor (nombre_proveedor, apellido_paterno, apellido_materno, telefono, email, direccion) VALUES (%s, %s, %s, %s, %s, %s)",
    ...
    def actualizar(self, proveedor):
        ...
        cursor = conexion.cursor()
        cursor.execute(
            "UPDATE proveedor SET nombre_proveedor = %s, apellido_paterno = %s, apellido_materno = %s, telefono = %s, email = %s, direccion = %s WHERE id_proveedor = %s",
